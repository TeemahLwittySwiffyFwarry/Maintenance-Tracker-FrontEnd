...
function ViewAllMachinesAd() {
  ...
  <div>
    <button onClick={() => window.print()} className="bg-green-500 text-white px-4 py-2 rounded">
      ...
      <h2 className="text-xl md:text-2xl font-bold text-center mt-72 md:mt-36 rounded-lg mb-4">All Equipments and Repair Price Details</h2>
...
export default ViewAllMachinesAd;
